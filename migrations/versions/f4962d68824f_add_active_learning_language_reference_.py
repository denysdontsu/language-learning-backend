...
def upgrade() -> None:
    ...
    op.add_column('exercises', sa.Column('question_translation_language', sa.Enum('UK', 'EN', 'DE', '_NAMES', name='language'), nullable=True, comment='Language code in ISO 639-1" format'))
