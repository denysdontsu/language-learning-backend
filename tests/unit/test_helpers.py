...
@pytest.mark.parametrize('exercise_type, options, correct_answer, expected', [
...
@pytest.mark.parametrize('period, date_from, date_to, expected, expectation', [
    (None, date(2000, 9, 18), date(1999, 9, 18), None, pytest.raises(HTTPException)),
    (None, date(2030, 9, 18), None, None, pytest.raises(HTTPException)),
